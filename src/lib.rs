...
#[pyfunction(beam_width = "128", cutoff_prob = "0.001", alpha = "2.0", beta = "1.5", blank_id = "28", space_id = "0")]
#[text_signature = "(network_output, alphabet, beam_width=128, cutoff_prob=0.001, alpha=2.0, beta=1.5, blank_id=28, space_id=0)"]
fn beam_search(
